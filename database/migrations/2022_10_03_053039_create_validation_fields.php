...
return new class extends Migration
{
  public function up()
  {
    Schema::create('validation_fields', function (Blueprint $table) {
      $table->id();
      $table->foreignId('validation_id')->constrained()->cascadeOnUpdate()->restrictOnDelete();
  ...
  {
    Schema::dropIfExists('validation_fields');
  }
};